...
Manage [Omarchy](https://omarchy.org/) Linux systems - a beautiful, modern, opinionated Fedora Linux distribution with Hyprland.
...
├── pre-refresh-repos.d/   # Before package sync during update
...
5. **Is it a package install?** Use `omarchy pkg add <pkgs...>` (or `omarchy pkg add <pkgs...> for COPR packages)
